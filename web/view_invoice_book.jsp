<%-- 
    Document   : view_invoice_book
    Created on : 06-Jun-2013, 17:01:04
                                    ...
                                    <table class="table table-hover table-nomargin dataTable table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class='upd'><a href="update_invoice_book.jsp"><i class="icon-edit icon-2x"></i></a></td>                                                            
                                            </tr>
                                              <tr>
                                                <td>IN-051</td>
                                                <td>IN-100</td>
