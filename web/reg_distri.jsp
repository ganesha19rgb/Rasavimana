<%-- 
    Document   : reg_distri
    Created on : 30-May-2013, 14:29:17
                ...
                <div class="container-fluid">
                    ...
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li>
                                <a href="#">Distributors Registration</a>
                            </li>
                        </ul>
                                ...
                                <div class="box-content">
                                    <form action="#" method="POST" class='form-horizontal form-validate' id="bb">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="dis_id" id="dis_id" class="input-xlarge" data-rule-required="true" data-rule-minlength="4">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="textfield" class="control-label">Name</label>
                                            <div class="controls">
                                                <input type="text" name="name" id="agent_name" class="input-xlarge"  data-rule-required="true">
                                            </div>
                                        </div>
