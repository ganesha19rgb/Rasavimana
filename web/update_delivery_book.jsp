<%-- 
    Document   : update_delivery_book
    Created on : 07-Jun-2013, 09:50:30
...
<html>
    <head>
        ...
        <title>Update Delivery Book</title>
                                ...
                                <div class="box-content">
                                    <form action="#" method="POST" class='form-horizontal form-validate' id="bb">
                                        ...
                                        <div class="control-group" style="float: left;padding-right: 5%;">
                                            <label for="textfield" class="control-label">Return No</label>
                                            <div class="controls">
                                                <input type="text" name="del_str" id="del_str" value="DE-001" class="input-xlarge" data-rule-required="true" >
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="textfield" class="control-label" style="width: 60px;">To</label>
                                            <div class="controls">
                                                <input type="text" name="del_end" id="del_end" value="DE-050" class="input-xlarge"  data-rule-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="remarks" id="remarks" rows="5" class="input-xlarge ">Some Text</textarea>
                                            </div>
                                        </div>
