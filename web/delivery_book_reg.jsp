<%-- 
    Document   : invoice_book
    Created on : 30-May-2013, 14:41:53
                                ...
                                <div class="box-content">
                                    <form action="#" method="POST" class='form-horizontal form-validate' id="bb">
                                        ...
                                        <div class="control-group" style="float: left;padding-right: 5%;">
                                            <label for="textfield" class="control-label">Delivery No</label>
                                            <div class="controls">
                                                <input type="text" name="del_str" id="invoice_str" class="input-xlarge" data-rule-required="true" >
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="textfield" class="control-label" style="width: 60px;">To</label>
                                            <div class="controls">
                                                <input type="text" name="del_end" id="invoice_end" class="input-xlarge"  data-rule-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="remarks" id="remarks" rows="5" class="input-xlarge "></textarea>
                                            </div>
                                        </div>
