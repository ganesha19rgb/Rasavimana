<%-- 
    Document   : magazine
    Created on : 10-Jun-2013, 11:06:21
                                ...
                                <div class="box-content">
                                    <ul class="tiles tiles-left ">
                                        <li class="pink long ">
                                            ...
                                            <a href="magazine_data_entry.jsp"><span><i class="icon-book"></i></span><span class='name'>Magazine Data Entry</span></a>
                                        </li>
                                        <li class="orange long ">
                                            <span class="label label-info">284</span>
                                            <a href="view_stock.jsp"><span><i class="icon-cloud"></i></span><span class='name'>Stock</span></a>
                                        </li>
