<%-- 
    Document   : reg_agent
    Created on : 28-May-2013, 13:58:13
                                ...
                                <div class="box-content">
                                    <form action="#" method="POST" class='form-horizontal form-validate' id="bb">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="agent_id" id="agent_id" class="input-xlarge" data-rule-required="true" data-rule-minlength="4">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="textfield" class="control-label">Agent Name</label>
                                            <div class="controls">
                                                <input type="text" name="agent_name" id="agent_name" class="input-xlarge"  data-rule-required="true">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            <label for="textfield" class="control-label">Agent Route</label>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="ag_phone" id="ag_phone" class="input-xlarge mask_phone">                                              
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="textfield" class="control-label">Address</label>
                                            <div class="controls">
                                                <input type="text"  name="ag_add" id="ag_add"  class="input-xlarge"  >                                               
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="textfield" class="control-label">District</label>
                                            <div class="controls">
                                                <select name="district" id="district" class='select2-me input-xlarge' style="width: 284px;">
                                                    <option value="01">Colombo - CL</option>
                                                    <option value="02">Kaluthara - KK</option>
                                                    <option value="03">Gampaha - GM</option>
                                                    <option value="04">Galle - GL</option>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text"  name="com_margin" id="com_margin" data-rule-number="true" class="input-small span1" data-rule-maxlength="5"> %                                                
                                            </div>                                            
                                        </div>
                                        ...
                                        <div class="control-group">
                                            <label for="numberfield" class="control-label">Generated Agent Id</label>
                                            <div class="controls">
                                                <input type="text"  name="agt_id2" id="agt_id2"  class="input-xlarge" disabled style="cursor: default;">                                                
                                            </div>                                            
                                        </div>
