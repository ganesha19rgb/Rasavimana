<%-- 
    Document   : update_return_book
    Created on : 07-Jun-2013, 09:29:51
...
<html>
    <head>
        ...
        <title>Update Return Book</title>
                                ...
                                <div class="box-content">
                                    <form action="#" method="POST" class='form-horizontal form-validate' id="bb">
                                        ...
                                        <div class="control-group" style="float: left;padding-right: 5%;">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="rtn_str" id="invoice_str" value="RE-001" class="input-xlarge" data-rule-required="true" >
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="textfield" class="control-label" style="width: 60px;">To</label>
                                            <div class="controls">
                                                <input type="text" name="rtn_end" id="invoice_end" value="RE-050" class="input-xlarge"  data-rule-required="true">
                                            </div>
                                        </div>
