<%-- 
    Document   : view_return
    Created on : 05-Jun-2013, 16:30:20
                                        ...
                                        <table class="table table-hover table-nomargin dataTable table-bordered dataTable-columnfilter" style="width: auto!important;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class='upd'><a href="update_return.jsp"><i class="icon-edit icon-2x"></i></a></td> 
