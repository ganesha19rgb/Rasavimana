<%-- 
    Document   : view_delivery_book
    Created on : 07-Jun-2013, 09:44:41
...
<html>
    <head>
        ...
        <title>View Delivery Book</title>
                                    ...
                                    <table class="table table-hover table-nomargin dataTable table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class='upd'><a href="update_delivery_book.jsp"><i class="icon-edit icon-2x"></i></a></td>                                                            
                                            </tr>
