<%-- 
    Document   : stock_out
    Created on : 20-Jun-2013, 10:20:07
                    ...
                    <div class="row-fluid">
                        <div class="span12">  
                                ...
                                <div class="span6">
                                    <div class="box box-color">
                                        <ul class="tiles" style="float: right;margin: 0px;">                                            
                                            <li class="green">                                               
                                                <a href="#"><span>5227</span><span class='name'>Total Returned</span></a>
                                            </li>
                                            <li class="blue">                                               
                                                <a href="#"><span>3200</span><span class='name'>Submitted</span></a>
                                            </li>
                                            <li class="red">                                               
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span2" style="padding-left: 1%;">
                                    <div class="row-fluid">
                                        <label for="textfield" class="control-label">Return ID</label> 
                                    </div>
                                    <div class="row-fluid">
                                        <select name="rtn_id" id="rtn_id" class='select2-me input-xlarge'style="width: 100px;"  >
                                            <option value="">R001</option>
                                            <option value="">R002</option>
                                            <option value="">R003</option>
                                ...
                                <div class="span2" style="padding-left: 1%;">
                                    ...
                                    <div class="row-fluid">
                                        <input type="text" name="rtn _qty" id="rtn_qty" onkeyup="grabFocus(event,this.id,'rtn_id');digitValidate(this.id);" class="input-small modify-input" data-rule-required="true" data-rule-digits="true">
                                        <%--
                                        <button class="btn btn-primary" style="margin-top: -10px;">Search</button>
                                        --%>                                   
                                    </div>
