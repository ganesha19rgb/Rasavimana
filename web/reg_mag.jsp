                ...
                <div class="container-fluid">
                    ...
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li>
                                <a href="#">Magazine Registration</a>
                            </li>
                        </ul>
                                ...
                                <div class="box-content">
                                    <form action="#" method="POST" class='form-horizontal form-validate' id="bb">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="mag_id" id="mag_id" class="input-xlarge" data-rule-required="true" data-rule-minlength="4">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="textfield" class="control-label">Month/Year</label>
                                            <div class="controls">
                                                <input type="text" name="month" id="month" class="input-xlarge"  data-rule-required="true">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="textfield" class="control-label">Selling Price</label>
                                            <div class="controls">
                                                <input type="text" name="sel_price" id="sel_price"  class="input-xlarge"  data-rule-required="true" data-rule-number="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="qty" id="qty" class="input-xlarge"   data-rule-required="true" data-rule-digits="true">
                                            </div>
                                        </div>                                       
                                            ...
                                            <table id="expense" class="table table-nomargin  table-bordered" style="width: 444px;border-top: 1px solid #ddd;">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td  class='hidden-350'> <div class="control-group" style="margin-bottom: 0;"> <div class="controls" style="margin-left: 0;">   <input type="text" name="sup_exp" id="sup_exp" class="input-medium"  data-rule-number="true"> </div></div></td>                                                       
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td  class='hidden-350'> <div class="control-group" style="margin-bottom: 0;"> <div class="controls" style="margin-left: 0;">   <input type="text" name="pol_exp" id="pol_exp" class="input-medium"  data-rule-number="true"> </div></div></td>                                                       
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td  class='hidden-350'> <div class="control-group" style="margin-bottom: 0;"> <div class="controls" style="margin-left: 0;">   <input type="text" name="tra_exp" id="pol_exp" class="input-medium"  data-rule-number="true"> </div></div></td>                                                       
                                                    </tr>
                                                    <tr>
                                                        <td  class='hidden-350'> <div class="control-group" style="margin-bottom: 0;"> <div class="controls" style="margin-left: 0;">   <input type="text"  class="input-medium"  data-rule-required="true" value="Other" > </div></div></td>                                                       
                                                        <td  class='hidden-350'> <div class="control-group" style="margin-bottom: 0;"> <div class="controls" style="margin-left: 0;">   <input type="text" name="tra_exp" id="pol_exp" class="input-medium"  data-rule-number="true"> </div></div></td>                                                       
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="total_cost" id="total_cost" class="input-xlarge"  data-rule-number="true" disabled style="cursor: pointer;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="mag_cost" id="mag_cost" class="input-xlarge"  data-rule-number="true" disabled style="cursor: pointer;">
                                            </div>
                                        </div>
