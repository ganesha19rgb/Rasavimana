<%-- 
    Document   : update_return
    Created on : 07-Jun-2013, 11:10:46
                                ...
                                <div class="box-content">
                                    <form action="#" method="POST" class='form-horizontal form-validate' id="bb">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text"  name="upd_ret_date" id="upd_deli_date" value="05/01/2010" data-rule-required="true"  class="input-medium datepick" style="width: 206px;">                                               
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="textfield" class="control-label">Deliver Id</label>
                                            <div class="controls">
                                                <select name="ret_id" id="ret_id" class='select2-me input-xlarge'style="width: 220px;"  >
                                                    <option value="">RE-001</option>
                                                    <option value="">RE-002</option>
                                                    <option value="03">RE-003</option>
