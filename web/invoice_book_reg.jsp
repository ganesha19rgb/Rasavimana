                                ...
                                <div class="box-content">
                                    <form action="#" method="POST" class='form-horizontal form-validate' id="bb">
                                        ...
                                        <div class="control-group" style="float: left;padding-right: 5%;">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="invoice_str" id="invoice_str" class="input-xlarge" data-rule-required="true" >
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="textfield" class="control-label" style="width: 60px;">To</label>
                                            <div class="controls">
                                                <input type="text" name="invoice_end" id="invoice_end" class="input-xlarge"  data-rule-required="true">
                                            </div>
                                        </div>
